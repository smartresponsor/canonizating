...
## Requirement
`composer.prod.json` is the production/container-build manifest. First-party component dependencies resolve as normal Composer packages/bundles rather than sibling filesystem links.
...
## Guardability
Hard. Gating validates presence of `composer.prod.json` for canonical platform components and rejects path/symlink repositories in that manifest.
