...
## Rationale
Composer sees vendor/package syntax only; the platform canon assigns architectural meaning to both positions. Keeping both identities explicit prevents namespace identity and PHP subject vocabulary from drifting together.
