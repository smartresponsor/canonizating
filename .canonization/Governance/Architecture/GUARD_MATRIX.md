...
| Canon053 | `Canon053SiblingComposerSymlinkIsolationRule.php` | hard | only Gating, Cruding, Viewing, and Interfacing may be exposed as symlinked sibling Composer path repositories |
