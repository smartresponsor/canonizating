...
| Canon053 | `Canon053SiblingComposerSymlinkIsolationRule.php` | hard | only Gating, Cruding, Viewing, Interfacing, Collectioning, Objecting, Tabling, Runtime, and Indexing may be exposed as symlinked sibling Composer path repositories |
